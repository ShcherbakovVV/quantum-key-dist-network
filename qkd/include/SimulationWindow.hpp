...
private:
    ...
    Gtk::Box wnd_box {Gtk::Orientation::VERTICAL};

    Gtk::Frame sim_frame {"Simulation settings"};
    Gtk::Grid sim_grid {};
    Gtk::Label sim_time_label {"Simulation time", Gtk::Align::START};
    Gtk::Grid sim_time_entry_grid {};
    Gtk::Entry sim_time_entry {};
    Gtk::ComboBoxText sim_time_entry_combo {};
    Gtk::Label sim_step_label {"Simulation step", Gtk::Align::START};
    ...
    Gtk::Grid queue_grid {};
    Gtk::Label queue_type_label {"Queue service order", Gtk::Align::START};
    Gtk::ComboBoxText queue_type_combo {};
    Gtk::Label queue_cap_label {"Request queue capacity, requests", Gtk::Align::START};
    Gtk::Entry queue_cap_entry {};
    Gtk::Label req_life_label {"Request lifetime", Gtk::Align::START};
    Gtk::Grid req_life_entry_grid {};
    Gtk::Entry req_life_entry {};
    Gtk::ComboBoxText req_life_entry_combo {};
    Gtk::Label req_arr_label {"Request arrival parameter", Gtk::Align::START};
    Gtk::Entry req_arr_entry {};
    Gtk::Label req_srv_label {"Request service parameter", Gtk::Align::START};
    Gtk::Entry req_srv_entry {};

    Gtk::Frame progress_frame {"Simulation progress"};
    Gtk::Box progress_box {Gtk::Orientation::VERTICAL};
    Gtk::ProgressBar progressbar {};
    Gtk::TextView textview {};
    Gtk::Box buttons_box {Gtk::Orientation::HORIZONTAL};

    Gtk::Button run_button {};
    Gtk::Box run_button_box {Gtk::Orientation::HORIZONTAL};
    Gtk::Image run_button_icon {};
    Gtk::Label run_button_label {"Run"};

    Gtk::Button stop_button {};
    Gtk::Box stop_button_box {Gtk::Orientation::HORIZONTAL};
